...
import { 
  ...
  LogOut, Lightbulb, Brain, Eye, Zap, Layers, 
  BarChart, Target, Share2, ShieldCheck, AlertTriangle, 
  Video, Image as ImageIcon, MonitorPlay, ListOrdered, Palette
} from 'lucide-react';

const ChapterTwoLesson = ({ onExit = () => console.log("Exit") }) => {
  ...
  const lessonData = [
    ...
    {
      type: 'comparison',
      title: 'تصحيح مفاهيم: جرافيك أم إنفوجرافيك أم موشن؟',
      items: [
        { name: 'الجرافيك', desc: 'أي شكل أو رمز لتوضيح أمر محدد (مثل بوستر عروض رمضان). لا يشرح تفاصيل.', icon: <ImageIcon className="w-10 h-10 text-gray-400" /> },
    ...
    },
    {
      ...
      content: 'تعتمد قوة الإنفوجرافيك على نظريات علم النفس وعمليات التفكير البصري (القدرة العقلية لتحويل الصور الذهنية لرسومات):',
      theories: [
        { name: '1. نظرية الجشطالت', desc: 'كيف ينظم الدماغ المعلومات لإنشاء معنى متكامل (قانون القرب، الشبه، الإغلاق). مثال: الألوان المتشابهة تعني معلومات مترابطة.' },
        { name: '2. النظرية البنائية', desc: 'المعرفة لا تُنقل بسلبية، بل تُبنى بنشاط. (يتم تطبيقها عبر جعل الإنفوجرافيك تفاعلياً يحث على الاستكشاف).' },
        { name: '3. معالجة المعلومات', desc: 'تشرح كيف يعالج الدماغ ويخزن في الذاكرة. (تُطبق بتبسيط وتقسيم المعلومات المعقدة).' },
    ...
    },
    {
      ...
      pros: [
        ...
        'جاذبية بصرية وقابلية عالية للمشاركة (يجلب زوار للموقع).',
        'يغطي كافة المجالات (طب، هندسة، تسويق، تعليم).',
        'يختصر وقت التعلم ويستبعد التفاصيل غير الضرورية.'
      ],
      cons: [
        'يستهلك الكثير من الوقت لجمع وصياغة المعلومات بدقة.',
        'تكلفة إضافية (تحتاج لمصممين محترفين أو منصات مدفوعة).',
        'هامش واسع لعدم النجاح (التصميم الجيد هو نصف العمل، التسويق له هو النصف الآخر).'
      ]
    },
    {
      type: 'steps',
      ...
      steps: [
        { num: 1, text: 'تحديد الهدف', sub: 'ما الذي تريد تحقيقه؟ عرض إحصائية أم شرح منتج؟' },
        { num: 2, text: 'الجمهور المستهدف', sub: 'معرفة خصائصهم تحدد الألوان والأسلوب (مثال: ألوان أنثوية، لغة مبسطة لطلاب).' },
        { num: 3, text: 'جمع المعلومات', sub: 'يجب أن تكون صحيحة، دقيقة، ومفيدة بلا توسع ممل ولا اختصار مخل.' },
        { num: 4, text: 'رسم المسودة', sub: 'توزيع كروكي على الورق (مربعات للنصوص وتحديد مساحات بيضاء لراحة العين).' },
        { num: 5, text: 'اختيار العناصر', sub: 'الألوان (نفسية الألوان)، الخطوط (عناوين جاذبة ونصوص واضحة)، والمخططات.' },
        { num: 6, text: 'التنفيذ ببرامج التصميم', sub: 'تجميع المكونات باستخدام برامج مثل Venngage, Piktochart, Infogram.' }
      ]
    },
    {
      type: 'content-grid',
      title: 'شروط الإنفوجرافيك الجيد',
      icon: <ShieldCheck className="w-12 h-12 text-green-400 mb-4" />,
      cards: [
        { title: 'المحتوى', text: 'يركز على موضوع واحد، خالٍ من الأخطاء العلمية واللغوية، ويحتوي إحصائيات دقيقة وموثقة المصادر.' },
        { title: 'التصميم', text: 'بسيط، ألوانه متناسقة، مسار القراءة متماسك (من صورة لما تليها)، وخالٍ من الكلمات غير الضرورية.' },
        { title: 'التواصل', text: 'يجب أن يوضح بيانات المصمم وطرق التواصل معه في نهاية التصميم.' }
      ]
    },
    {
      type: 'quiz',
      title: 'سؤال أخير للعباقرة 🏆',
      question: 'حسب نظرية الجشطالت في علم النفس، تصميم إنفوجرافيك يضع العناصر المرتبطة ببعضها في مساحات متقاربة يعتمد على قانون:',
  ...
  return (
    <div className="w-full min-h-screen bg-[#070b14] text-white flex items-center justify-center p-4 sm:p-8 font-sans overflow-hidden" dir="rtl">
      ...
      {/* Main Container */}
      <div className="relative z-10 w-full max-w-6xl bg-[#0f172a]/60 backdrop-blur-2xl border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.8)] rounded-[2rem] p-6 sm:p-10 flex flex-col min-h-[75vh] transition-all duration-500">
        
        {/* Header Controls */}
        <div className="flex justify-between items-center mb-8 border-b border-white/10 pb-6">
          <button onClick={onExit} className="flex items-center gap-2 text-white/50 hover:text-red-400 hover:bg-red-400/10 px-5 py-2.5 rounded-xl text-sm font-bold border border-transparent hover:border-red-500/30 transition-all">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 w-full">
                {slide.stats.map((stat, idx) => (
                  <div key={idx} className="bg-white/5 border border-white/10 p-6 rounded-3xl flex flex-col items-center justify-center text-center hover:bg-white/10 transition-all hover:-translate-y-2 group">
                    <div className={`text-4xl font-black ${stat.color} mb-4 drop-shadow-[0_0_15px_rgba(255,255,255,0.2)] group-hover:scale-110 transition-transform`}>
                      {stat.num}
                    </div>
            ...
            <div className="w-full flex flex-col items-center max-w-4xl">
              ...
              <div className="flex flex-col gap-4 w-full">
                {slide.theories.map((theory, idx) => (
                  <div key={idx} className="flex gap-6 bg-white/5 p-5 rounded-2xl border border-white/5 items-center">
            ...
            <div className="w-full flex flex-col items-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
                {slide.steps.map((step, idx) => (
                  <div key={idx} className="relative bg-[#162032] border border-white/10 p-6 rounded-2xl pt-10 mt-6">
...
export default ChapterTwoLesson;
